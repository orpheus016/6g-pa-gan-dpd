#!/bin/bash
# Triple Training Workflow Example
# This shows the complete workflow for training and exporting 3 temperature banks
...
# Step 2: Train each temperature separately
...
echo ""
echo "Total BRAM: 9.3 KB (3 banks × 1,554 params × 16-bit)"
echo ""
