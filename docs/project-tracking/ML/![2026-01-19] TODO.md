...
- [ ] FIX jupyter notebook to match train.py and ARCHITECTURE.md (memory depth M=3, phase-normalized features, no Tanh at output)
    ...
    - [ ] Change directory for data loading in the notebook
    ...
    - [ ] Verify validation and implement plotting first with utils/metrics.py from OpenDPD repo a bit sus they havent used modules to calculate evm acpr nmse check this first like compare from the spectrallloss compute metrics to their computation
